...
app.get('/sessionValues', (req, res) => {
  let sessionValues = { nombre: req.session.nombre, contador: req.session.contador, otro: req.session.otro }
  res.send(sessionValues)
})
